...
export const metadata: Metadata = {
  title: "All Cities Air Quality Index (AQI)",
  description: "View real-time Air Quality Index (AQI), PM2.5 levels, and 48-hour forecasts for all monitored cities across India and globally.",
  alternates: {
    canonical: "/cities",
  },
};
    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="hero-atmosphere rounded-2xl p-8 text-center border border-[#1E293B]/50">
        ...
        <p className="text-[#94A3B8] max-w-2xl mx-auto text-lg leading-relaxed">
          Select a city below to view its real-time Air Quality Index (AQI), 48-hour ML forecast, dominant pollutants, and health recommendations.
        </p>
      </div>
